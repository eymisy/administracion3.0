...
# catalogo = Catalogo(host="localhost", user="root", password="", database="miapp")
catalogo = Catalogo(host='eymisy.mysql.pythonanywhere-services.com', user='eymisy', password='root-123456', database='eymisy$miapp')

# Carpeta para guardar las imagenes
#ruta_destino = './static/imagenes/'
ruta_destino = '/home/eymisy/static/imagenes/'   #recordar poner / después de imágenes
